...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About MortyCoin", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>MortyCoin</b> version", Q_NULLPTR));
...
"Copyright \302\251 2017 The MortyCoin developers", Q_NULLPTR));
